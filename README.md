...
|Роль|Участник|
| ------------------------------- | ------------------- |
|Менеджер проекта и релиз-менеджер|Чан Дык Мань|
|Архитектор и разработчик|Нгуен Тхи Тхуи Линь|
|Бизнес-аналитик и тестер|Нгуен Куанг Тхай|
|Разработчик|Нгуен Тхань Чунг|
|Разработчик|Чинь Ван Хю|
|Разработчик|Фам Вьет Ань|
## Этап 1. 
**Проанализировать выбранный вариант описания проектируемой системы.**\
...
```
- Далее следует предварительная информация о том, как быть членом общежития.: \
```
passport
address
sex
...
```
И множество других отличительных особенностей: 
```
gender
number_person
type_room
...
## Этап  3.
**Реализовать диаграмму «сущность-связь» модели базы данных в нотации IDEF1X.**
![](assets/14x.jpg)

## Этап  4. 
**Создать базу данных для СУБД и сгенерировать sql-скрипт для задания структуры базы данных. Выполнить анализ sql-скрипта создания базы данных и ассоциированных с ней объектов (таблиц и ограничений).**
 ```
...
```
## Этап  5. 
**Создать и выполнить запросы на добавление данных в таблицы (данные придумать самостоятельно). Создать и выполнить запросы на выборку данных из таблиц согласно условию**
...
![](assets/8.jpg)
## Этап  9. 
**Проанализировать выбранный вариант описания проектируемой системы. Сформулировать требования к системе с применением диаграммы прецедентов. Создать начальную версию диаграммы прецедентов.**
![](assets/9x.jpg)
## Этап  10. 
**Создать модель статической структуры системы и связей между ее элементами с помощью диаграммы классов. Реализовать диаграмму классов.**
![](assets/10.jpg)
## Этап  11. 
**Создать модель процесса обмена сообщениями между объектами в виде диаграмм последовательностей и кооперации. Реализовать диаграммы последовательностей и кооперации.**
![](assets/11.jpg)
## Этап  12. 
**Создать модель поведения системы в рамках прецедентов с помощью диаграмм деятельностей. Реализовать диаграммы деятельностей.** 
![](assets/12.jpg)
## Этап 14. 
